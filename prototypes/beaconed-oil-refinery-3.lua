...
beaconed_oil_refinery_3.energy_source.emissions_per_minute = beaconed_stats(beaconed_data).beaconed_emissions_per_minute
...
data:extend({
  {
    ...
    stack_size = 10,
    localised_description = {'item-description.beaconed-oil-refinery-3', global_oil_refinery_beacon_count}
  },
})
data:extend({
  {
    ...
    ingredients =
    {
      ...
      {"speed-module-3", global_oil_refinery_average_beacon_count * global_beacon_module_slots}
    },
    results = {
