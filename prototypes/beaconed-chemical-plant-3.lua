...
data:extend({
  {
    ...
    minable = {mining_time = 0.1, result = "beaconed-chemical-plant-3"},
    max_health = 300,
    corpse = "big-remnants",
    ...
    {
      {
        ...
        animation =
        {
          ...
          width = 15,
          height = 10,
          animation_speed = beaconed_chemical_plant_3_animation_speed,
          hr_version =
          {
    ...
    energy_source =
    {
      ...
      emissions_per_second_per_watt = 4 / 210000 * 1.3,
      drain = "3367kW"
    },
    energy_usage = "2478kW",
