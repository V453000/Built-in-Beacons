...
beaconed_electric_furnace_2.working_visualisations =
{
  {
    animation =
    {
    ...
    light = {intensity = 0.7, size = 10, shift = {0.0, 1.0}, color = {r = 1.0, g = 1.0, b = 1.0}}
  },
  {
    animation =
    {
    ...
    --light = {intensity = 0.7, size = 6, shift = {0.0, 1.0}, color = {r = 1.0, g = 1.0, b = 1.0}}
  },
  --{
  --  animation =
  --  {
