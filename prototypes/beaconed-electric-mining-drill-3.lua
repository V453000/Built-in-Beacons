...
beaconed_electric_mining_drill_3.energy_source.emissions_per_minute.pollution = beaconed_stats(beaconed_data).beaconed_emissions_per_minute
...
beaconed_electric_mining_drill_3.module_slots = 0

-- if settings.startup["show-module-slot-row-length"].value > 0 then
--   beaconed_electric_mining_drill_3.module_info_max_icons_per_row = settings.startup["show-module-slot-row-length"].value
-- end
-- if settings.startup["show-module-slot-rows"].value > 0 then
--   beaconed_electric_mining_drill_3.module_info_max_icon_rows = settings.startup["show-module-slot-rows"].value
-- end
...
data:extend({
  {
    ...
    stack_size = 50,
    localised_description = {'item-description.beaconed-electric-mining-drill-3', tostring(global_electric_mining_drill_beacon_count)}
  },
})
data:extend({
  {
    ...
    ingredients =
    {
      ...
      {type = "item", name = "speed-module-3", amount = global_electric_mining_drill_average_beacon_count * global_beacon_module_slots}
    },
    results = {
