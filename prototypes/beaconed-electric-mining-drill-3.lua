...
local beaconed_electric_drill_3_animation_speed = beaconed_stats(beaconed_data).beaconed_animation_speed
...
beaconed_electric_mining_drill_3.mining_speed = beaconed_stats(beaconed_data).beaconed_crafting_speed
...
beaconed_electric_mining_drill_3.module_specification.module_slots = 0
...
local vertical_overlay_graphics =
{
  ...
  height = 82,
  frame_count = 30,
  animation_speed = beaconed_electric_mining_drill_3.graphics_set.working_visualisations[3].north_animation.layers[1].animation_speed,
  frame_sequence = beaconed_electric_mining_drill_3.graphics_set.working_visualisations[3].north_animation.layers[1].frame_sequence,
  ...
  hr_version =
  {
    ...
    height = 164,
    frame_count = 30,
    animation_speed = beaconed_electric_mining_drill_3.graphics_set.working_visualisations[3].north_animation.layers[1].hr_version.animation_speed,
    frame_sequence = beaconed_electric_mining_drill_3.graphics_set.working_visualisations[3].north_animation.layers[1].hr_version.frame_sequence,
    tint = beaconed_electric_mining_drill_3_tint,
    shift = util.by_pixel(0, -8),
    scale = 0.5
  }
...
local horizontal_overlay_graphics =
{
  ...
  height = 86,
  frame_count = 30,
  animation_speed = beaconed_electric_mining_drill_3.graphics_set.working_visualisations[3].east_animation.layers[1].animation_speed,
  frame_sequence = beaconed_electric_mining_drill_3.graphics_set.working_visualisations[3].east_animation.layers[1].frame_sequence,
  tint = beaconed_electric_mining_drill_3_tint,
  ...
  hr_version =
  {
    ...
    height = 170,
    frame_count = 30,
    animation_speed = beaconed_electric_mining_drill_3.graphics_set.working_visualisations[3].east_animation.layers[1].hr_version.animation_speed,
    frame_sequence = beaconed_electric_mining_drill_3.graphics_set.working_visualisations[3].east_animation.layers[1].hr_version.frame_sequence,
    tint = beaconed_electric_mining_drill_3_tint,
    shift = util.by_pixel(2, -9),
    scale = 0.5
  }
...
local horizontal_front_overlay_graphics =
{
  ...
  height = 74,
  frame_count = 30,
  animation_speed = beaconed_electric_mining_drill_3.graphics_set.working_visualisations[6].east_animation.animation_speed,
  frame_sequence = beaconed_electric_mining_drill_3.graphics_set.working_visualisations[6].east_animation.frame_sequence,
  tint = beaconed_electric_mining_drill_3_tint,
  ...
  hr_version =
  {
    ...
    height = 146,
    frame_count = 30,
    animation_speed = beaconed_electric_mining_drill_3.graphics_set.working_visualisations[6].east_animation.hr_version.animation_speed,
    frame_sequence = beaconed_electric_mining_drill_3.graphics_set.working_visualisations[6].east_animation.hr_version.frame_sequence,
    tint = beaconed_electric_mining_drill_3_tint,
...
if settings.startup["modded-entity-graphics"].value == "ON" then
  table.insert(beaconed_electric_mining_drill_3.graphics_set.working_visualisations[3].north_animation.layers, vertical_overlay_graphics )
  table.insert(beaconed_electric_mining_drill_3.graphics_set.working_visualisations[3].south_animation.layers, vertical_overlay_graphics )
  table.insert(beaconed_electric_mining_drill_3.graphics_set.working_visualisations[3].east_animation.layers, horizontal_overlay_graphics )
  table.insert(beaconed_electric_mining_drill_3.graphics_set.working_visualisations[3].west_animation.layers, horizontal_overlay_graphics )
  
  beaconed_electric_mining_drill_3.graphics_set.working_visualisations[6].east_animation = create_layers(beaconed_electric_mining_drill_3.graphics_set.working_visualisations[6].east_animation, horizontal_front_overlay_graphics)
  beaconed_electric_mining_drill_3.graphics_set.working_visualisations[6].west_animation = create_layers(beaconed_electric_mining_drill_3.graphics_set.working_visualisations[6].west_animation, horizontal_front_overlay_graphics)
end
...
data:extend({
  {
    ...
    stack_size = 50,
    localised_description = {'item-description.beaconed-electric-mining-drill-3', global_electric_mining_drill_beacon_count}
  },
})
data:extend({
  {
