...
if settings.startup["productivity-mode"].value == 'Modded Modules' then
  beaconed_lab_3.module_slots = data.raw["lab"]["lab"].module_slots * 2
  if settings.startup["show-module-slot-row-length"].value > 0 then
    beaconed_lab_3.module_info_max_icons_per_row = settings.startup["show-module-slot-row-length"].value
  end
  if settings.startup["show-module-slot-rows"].value > 0 then
    beaconed_lab_3.module_info_max_icon_rows = settings.startup["show-module-slot-rows"].value
  end
else
  beaconed_lab_3.module_slots = 0
...
data:extend({
  {
    ...
    stack_size = 10,
    localised_description = {'item-description.beaconed-lab-3', tostring(global_lab_beacon_count)}
  },
})
data:extend({
  {
    ...
    ingredients =
    {
      ...
      {type = "item", name = "speed-module-3", amount = global_lab_average_beacon_count * global_beacon_module_slots}
    },
    results = {
