...
data:extend({
  {
    ...
    minable = {mining_time = 0.1, result = "beaconed-centrifuge"},
    max_health = 350,
    corpse = "big-remnants",
    ...
    next_upgrade = "beaconed-centrifuge-2",
    ...
    idle_animation =
    {
      layers =
      {
        -- Centrifuge A
        {
          ...
          height = 107,
          frame_count = 64,
          animation_speed = beaconed_centrifuge_1_animation_speed,
    ...
    energy_source =
    {
      ...
      emissions_per_second_per_watt = 4 / 350000 * 1.1,
      drain = "3372kW"
    },
    energy_usage = "2730kW",
