data:extend({
  {
    ...
    enabled = false,
    icon = "__Absorbed-Beacons__/graphics/icons/beaconed-rocket-silo.png",
    icon_size = 32,
...
data:extend({
  {
    ...
    minable = {mining_time = 1, result = "beaconed-rocket-silo"},
    max_health = 5000,
    corpse = "big-remnants",
    ...
    energy_usage = "3150kW", --energy usage used when crafting the rocket
    idle_energy_usage = "9608kW",
    lamp_energy_usage = "10KW",
    active_energy_usage = "50400kW",
    rocket_entity = "rocket-silo-rocket",

    fast_replaceable_group = "rocket-silo",
    next_upgrade = "beaconed-rocket-silo-2",
