...
if settings.startup["modded-entity-graphics"].value == "ON" then
  beaconed_rocket_silo_2.base_day_sprite = 
  {
    layers =
    {
      ...
      },--layer from base game
      {
        ...
        tint = beaconed_rocket_silo_2_tint,
        hr_version =
        {
  ...
  beaconed_rocket_silo_2.satellite_animation = 
  {
    layers =
    {
      {
  ...
  beaconed_rocket_silo_2.base_front_sprite =
  {
    layers =
    {
      {
  ...
  beaconed_rocket_silo_2.arm_01_back_animation =
  {
    layers =
    {
      {
  ...
  beaconed_rocket_silo_2.arm_02_right_animation =
  {
    layers =
    {
      {
  ...
  beaconed_rocket_silo_2.arm_03_front_animation =
  {
    layers =
    {
      {
  ...
  beaconed_rocket_2.rocket_sprite = 
  {
    layers =
    {
      {
