...
data:extend({
  {
    ...
    minable = {mining_time = 1, result = "beaconed-rocket-silo-2"},
    max_health = 5000,
    corpse = "big-remnants",
    ...
    energy_usage = "3850kW", --energy usage used when crafting the rocket
    idle_energy_usage = "9608kW",
    lamp_energy_usage = "10KW",
    active_energy_usage = "61600kW",
    rocket_entity = "rocket-silo-rocket",

    fast_replaceable_group = "rocket-silo",
    next_upgrade = "beaconed-rocket-silo-3",
