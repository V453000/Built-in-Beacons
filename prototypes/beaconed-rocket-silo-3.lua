...
if settings.startup["productivity-mode"].value == 'Modded Modules' then
  ...
  beaconed_rocket_silo_3.module_specification.module_slots = 0
...
data:extend({
  {
    ...
    stack_size = 1,
    localised_description = {'item-description.beaconed-rocket-silo-3', global_rocket_silo_beacon_count}
  },
})
data:extend({
  {
    ...
    ingredients =
    {
      ...
      {"speed-module-3", global_rocket_silo_average_beacon_count * global_beacon_module_slots}
    },
    results = {
