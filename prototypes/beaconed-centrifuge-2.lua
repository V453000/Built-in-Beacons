...
data:extend({
  {
    ...
    minable = {mining_time = 0.1, result = "beaconed-centrifuge-2"},
    max_health = 350,
    corpse = "big-remnants",
    ...
    next_upgrade = "beaconed-centrifuge-3",
    ...
    idle_animation =
    {
      layers =
      {
        -- Centrifuge A
        {
          ...
          height = 107,
          frame_count = 64,
          animation_speed = beaconed_centrifuge_2_animation_speed,
    ...
    energy_source =
    {
      ...
      emissions_per_second_per_watt = 4 / 350000 * 1.14,
      drain = "3372kW"
    },
    energy_usage = "3290kW",
