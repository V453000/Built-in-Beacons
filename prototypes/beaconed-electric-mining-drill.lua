...
if settings.startup["modded-entity-graphics"].value == "ON" then
  -- table.insert(beaconed_electric_mining_drill.graphics_set.working_visualisations[3].north_animation.layers, 
  -- {
  --   priority = "high",
  ...
  --   --frame_sequence = beaconed_electric_mining_drill.graphics_set.working_visualisations[3].north_animation.layers[1].shadow_sequence,
  ...
  --     --frame_sequence = beaconed_electric_mining_drill.graphics_set.working_visualisations[3].north_animation.layers[1].hr_version.shadow_sequence,
  --     tint = beaconed_electric_mining_drill_1_tint,
  --     shift = util.by_pixel(0, -8),
  --     scale = 0.5
  --   }
