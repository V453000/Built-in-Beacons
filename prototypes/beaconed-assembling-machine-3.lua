...
beaconed_assembling_machine_3.energy_source.emissions_per_minute = beaconed_stats(beaconed_data).beaconed_emissions_per_minute--2 / 375000
...
if settings.startup["productivity-mode"].value == 'Modded Modules' then
  ...
  beaconed_assembling_machine_3.module_specification.module_slots = 0
...
data:extend({
  {
    ...
    stack_size = 50,
    localised_description = {'item-description.beaconed-assembling-machine-3', global_assembling_machine_beacon_count}
  },
})
data:extend({
  {
