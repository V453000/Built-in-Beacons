...
beaconed_assembling_machine_2.energy_source.emissions_per_minute = beaconed_stats(beaconed_data).beaconed_emissions_per_minute--2 / 375000
...
if settings.startup["productivity-mode"].value == 'Modded Modules' then
  ...
  beaconed_assembling_machine_2.module_specification.module_slots = 0
