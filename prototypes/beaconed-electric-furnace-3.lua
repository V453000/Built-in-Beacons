...
beaconed_electric_furnace_3.energy_source.emissions_per_minute = beaconed_stats(beaconed_data).beaconed_emissions_per_minute
...
if settings.startup["productivity-mode"].value == 'Modded Modules' then
  ...
  beaconed_electric_furnace_3.module_specification.module_slots = 0
...
beaconed_electric_furnace_3.working_visualisations[2].animation =
{
  layers =
  {
    {
...
beaconed_electric_furnace_3.working_visualisations[3].animation =
{
  layers =
  {
    {
