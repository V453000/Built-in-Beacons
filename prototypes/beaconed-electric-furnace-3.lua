...
local beaconed_data = {
  ...
  tier_animation_speed_multiplier   = global_tier_3_furnace_animation_speed_multiplier,
  custom_animation_speed_multiplier = 1,
  emission_hack                     = 1
}
local beaconed_electric_furnace_3_animation_speed = beaconed_stats(beaconed_data).beaconed_animation_speed
...
beaconed_electric_furnace_3.icon = "__Built-in-Beacons__/graphics/icons/beaconed-electric-furnace-3.png"
beaconed_electric_furnace_3.minable.result = "beaconed-electric-furnace-3"
beaconed_electric_furnace_3.crafting_speed = beaconed_stats(beaconed_data).beaconed_crafting_speed
beaconed_electric_furnace_3.energy_source.emissions_per_minute.pollution = beaconed_stats(beaconed_data).beaconed_emissions_per_minute
beaconed_electric_furnace_3.energy_source.drain = beaconed_stats(beaconed_data).beaconed_drain_string
beaconed_electric_furnace_3.energy_usage = beaconed_stats(beaconed_data).beaconed_energy_usage_string
...
if settings.startup["productivity-mode"].value == 'Modded Modules' then
  beaconed_electric_furnace_3.module_slots = data.raw["furnace"]["electric-furnace"].module_slots * 2
  if settings.startup["show-module-slot-row-length"].value > 0 then
    beaconed_electric_furnace_3.module_info_max_icons_per_row = settings.startup["show-module-slot-row-length"].value
  end
  if settings.startup["show-module-slot-rows"].value > 0 then
    beaconed_electric_furnace_3.module_info_max_icon_rows = settings.startup["show-module-slot-rows"].value
  end
else
  beaconed_electric_furnace_3.module_slots = 0
  beaconed_electric_furnace_3.base_productivity = beaconed_stats(beaconed_data).beaconed_base_productivity
end

if settings.startup["modded-entity-graphics"].value == "ON" then
beaconed_electric_furnace_3.graphics_set.animation =
{
  layers =
  {
    {
      filename = "__Built-in-Beacons__/graphics/entity/beaconed-electric-furnace-3/beaconed-electric-furnace-3-base.png",
      priority = "high",
      width = 129,
      height = 100,
      frame_count = 1,
      ...
      hr_version =
      {
        filename = "__Built-in-Beacons__/graphics/entity/beaconed-electric-furnace-3/hr-beaconed-electric-furnace-3-base.png",
        priority = "high",
        width = 239,
        height = 219,
        frame_count = 1,
    ...
    },
    {
      ...
      tint = beaconed_electric_furnace_3_tint,
      hr_version =
      {
...
beaconed_electric_furnace_3.graphics_set.working_visualisations[2] =
{
  layers =
  {
    {
...
beaconed_electric_furnace_3.graphics_set.working_visualisations[3] =
{
  layers =
  {
    {
...
if settings.startup["modded-entity-graphics"].value ~= "OFF" then
  ...
  for i,layer in pairs(beaconed_electric_furnace_3.graphics_set.working_visualisations) do
...
data:extend({
  {
    ...
    icon = "__Built-in-Beacons__/graphics/icons/beaconed-electric-furnace-3.png",
    icon_size = 64,
    icon_mipmaps = 4,
    ...
    stack_size = 50,
    localised_description = {'item-description.beaconed-electric-furnace-3', tostring(global_electric_furnace_beacon_count)}
  },
})
data:extend({
  {
    ...
    ingredients =
    {
      ...
      {type = "item", name = "speed-module-3", amount = global_electric_furnace_average_beacon_count * global_beacon_module_slots}
    },
    results = {
