...
global_speed_module_1_consumption_bonus = data.raw["module"]["speed-module"].effect.speed.bonus --or 0
global_speed_module_2_consumption_bonus = data.raw["module"]["speed-module-2"].effect.speed.bonus --or 0
global_speed_module_3_consumption_bonus = data.raw["module"]["speed-module-3"].effect.speed.bonus --or 0
global_productivity_module_1_consumption_bonus = data.raw["module"]["productivity-module"].effect.consumption.bonus --or 0
global_productivity_module_2_consumption_bonus = data.raw["module"]["productivity-module-2"].effect.consumption.bonus --or 0
global_productivity_module_3_consumption_bonus = data.raw["module"]["productivity-module-3"].effect.consumption.bonus --or 0
