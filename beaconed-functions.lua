...
maxspeed_beaconed_assembling_machine_3_tint = {0.05, 0.175+0.2 , 0.25, 0}
...
beaconed_electric_mining_drill_1_tint       = {0,  0.2,  0.6, 0}
beaconed_electric_mining_drill_2_tint       = {0,  0.3, 0.45, 0}
beaconed_electric_mining_drill_3_tint       = {0,  0.5,  0.4, 0}
...
beaconed_pumpjack_1_tint                    = {0,  0.0,  0.4, 0}
beaconed_pumpjack_2_tint                    = {0,  0.2,  0.4, 0}
beaconed_pumpjack_3_tint                    = {0,  0.4,  0.4, 0}
